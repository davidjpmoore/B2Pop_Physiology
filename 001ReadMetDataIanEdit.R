...
#extract one day (6/8/2014)'s Air Temp
#make new object with just that day's values 
test <- Met_dat$RH[Met_dat$rDate=="2014-06-08"]
plot(test)
summary(test)



test <- Met_dat$AirTC_Avg[Met_dat$rDate]
